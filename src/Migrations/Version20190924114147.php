 ...
 */
final class Version20190924114147 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE horse_in_race DROP CONSTRAINT FK_4D3817556E59D40D');
        $this->addSql('ALTER TABLE horse_in_race DROP CONSTRAINT FK_4D38175576B275AD');
        $this->addSql('DROP SEQUENCE race_id_seq CASCADE');
        $this->addSql('DROP SEQUENCE horse_in_race_id_seq CASCADE');
